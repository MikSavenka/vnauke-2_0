		...
		<div class="block">
			...
			<form action="{PAGEEDIT_FORM_SEND}" enctype="multipart/form-data" method="post" name="pageform">
				<table class="cells">
					...
					<tr>
						<td>{PAGEEDIT_FORM_SOB_NACHALO_PODACHI_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_NACHALO_PODACHI}</td>
					</tr>


					<tr>
						<td>{PAGEEDIT_FORM_SOB_DEDLAIN_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_DEDLAIN}</td>
					</tr>


					<tr>
						<td>{PAGEEDIT_FORM_SOB_NACHALO_KONF_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_NACHALO_KONF}</td>
					</tr>


					<tr>
						<td>{PAGEEDIT_FORM_SOB_KONEC_KONF_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_KONEC_KONF}</td>
					</tr>

					<tr>
						<td>{PAGEEDIT_FORM_SOB_STRANA_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_STRANA}</td>
					</tr>

					<tr>
						<td>{PAGEEDIT_FORM_SOB_GOROD_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_GOROD}</td>
					</tr>
										<tr>
						<td>{PAGEEDIT_FORM_SOB_PLATNO_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_PLATNO}</td>
					</tr>

										<tr>
						<td>{PAGEEDIT_FORM_SOB_CONT_MAIL_TITLE}:</td>
						<td>{PAGEEDIT_FORM_SOB_CONT_MAIL}</td>
					</tr>
					<tr>
						<td>{PHP.L.Begin}:</td>
					...
					<tr>
						<td>{PAGEEDIT_FORM_BIG_LIST_PICT_TITLE}:</td>
						<td>{PAGEEDIT_FORM_BIG_LIST_PICT}</td>
					</tr>
					<!-- END: ADMIN -->
	<tr>
						<td>{PHP.L.Parser}:</td>

...
<tr>
						<td>{PAGEEDIT_FORM_IMG1024_TITLE}</td>
						<td>{PAGEEDIT_FORM_IMG1024}</td>
					</tr>

	<tr>
						<td>Миниатюра</td>
						<td>Delete avatar: {PAGEEDIT_FORM_AVATARDELETE} <br /> Avatar: {PAGEEDIT_FORM_AVATARFILE} <br /> {PAGEEDIT_FORM_AVATAR}</td>
					</tr>
					<tr>

		...
		<div class="block">
			...
			<form action="{PAGEEDIT_FORM_SEND}" enctype="multipart/form-data" method="post" name="pageform">
				<table class="cells">
					...
					<tr>
						<td>{PAGEEDIT_FORM_MATER_DOWNLOAD_LINK_TITLE}:</td>
						<td>{PAGEEDIT_FORM_MATER_DOWNLOAD_LINK}</td>
					</tr>
					<tr>
						<td>{PAGEEDIT_FORM_MATER_DATE_TITLE}:</td>
						<td>{PAGEEDIT_FORM_MATER_DATE}</td>
					</tr>
					<tr>
						<td>{PAGEEDIT_FORM_MATER_PLACE_TITLE}:</td>
						<td>{PAGEEDIT_FORM_MATER_PLACE}</td>
					</tr>
					<tr>
						<td>{PAGEEDIT_FORM_MATER_SCIENCE_TITLE}:</td>
						<td>{PAGEEDIT_FORM_MATER_SCIENCE}</td>
					</tr>
					<tr>
						<td>{PAGEEDIT_FORM_MATER_ORGANIZATOR_TITLE}:</td>
						<td>{PAGEEDIT_FORM_MATER_ORGANIZATOR}</td>
					</tr>
					<!-- END: ADMIN -->
	<tr>
						<td>{PHP.L.Parser}:</td>

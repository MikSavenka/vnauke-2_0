...
{FILE "{PHP.cfg.themes_dir}/{PHP.cfg.defaulttheme}/warnings.tpl"}
  <div id="header" class="innerpage">
	...
	<tr>
						<td>{PAGEADD_FORM_MATER_DOWNLOAD_LINK_TITLE}:</td>
						<td>{PAGEADD_FORM_MATER_DOWNLOAD_LINK}</td>
					</tr>
					<tr>
						<td>{PAGEADD_FORM_MATER_DATE_TITLE}:</td>
						<td>{PAGEADD_FORM_MATER_DATE}</td>
					</tr>
					<tr>
						<td>{PAGEADD_FORM_MATER_PLACE_TITLE}:</td>
						<td>{PAGEADD_FORM_MATER_PLACE}</td>
					</tr>
					<tr>
						<td>{PAGEADD_FORM_MATER_SCIENCE_TITLE}:</td>
						<td>{PAGEADD_FORM_MATER_SCIENCE}</td>
					</tr>
					<tr>
						<td>{PAGEADD_FORM_MATER_ORGANIZATOR_TITLE}:</td>
						<td>{PAGEADD_FORM_MATER_ORGANIZATOR}</td>
					</tr>
					<!-- END: ADMIN -->
					<tr>
						<td colspan="2">

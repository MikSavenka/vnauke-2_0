		...
		<div class="block">
			...
			<form action="{PAGEEDIT_FORM_SEND}" enctype="multipart/form-data" method="post" name="pageform">
				<table class="cells">
					...
					<tr>
						<td>{PAGEEDIT_FORM_TOVAR_TITLE_TITLE}:</td>
						<td>{PAGEEDIT_FORM_TOVAR_TITLE}</td>
					</tr>
					<tr>
						<td>{PAGEEDIT_FORM_TOVAR_SHORT_DESC_TITLE}:</td>
						<td>{PAGEEDIT_FORM_TOVAR_SHORT_DESC}</td>
					</tr>
					<tr>
...
<td>Миниатюра</td>
						<td>{PAGEEDIT_FORM_AVATAR}
							...
							<br/>{PAGEEDIT_FORM_AVATARFILE} Удалить: {PAGEEDIT_FORM_AVATARDELETE}
							<!-- ENDIF -->
							{PAGEEDIT_ATTACH}
						</td>
					</tr>
					...
					<tr>
						...
						<tr>
						<td>{PAGEEDIT_FORM_SHOP_PRICE_TITLE}</td>
						<td>{PAGEEDIT_FORM_SHOP_PRICE}</td>
					</tr>
	<tr>
						<td>{PAGEEDIT_FORM_SHOP_INSTOCK_TITLE}</td>
						<td>{PAGEEDIT_FORM_SHOP_INSTOCK}</td>
					</tr>	
							<tr>
						<td>{PAGEEDIT_FORM_SALE_TITLE}</td>
						<td>{PAGEEDIT_FORM_SALE}</td>
					</tr>
	<tr>
						<td>{PAGEEDIT_FORM_SHOP_PRICE_OLD_TITLE}</td>
						<td>{PAGEEDIT_FORM_SHOP_PRICE_OLD}</td>
					</tr>
	<tr>
						<td>{PAGEEDIT_FORM_SALE_DESCRIPTION_TITLE}</td>
						<td>{PAGEEDIT_FORM_SALE_DESCRIPTION}</td>
					</tr>
	
	<tr>
						<td>{PAGEEDIT_FORM_TOVAR_PICTURE_ALT_TITLE}</td>
						<td>{PAGEEDIT_FORM_TOVAR_PICTURE_ALT}</td>
					</tr>
	

	<tr>
						<td>{PAGEEDIT_FORM_BRAND_NAME_TITLE}</td>
						<td>{PAGEEDIT_FORM_BRAND_NAME}</td>
					</tr>
	<tr>
						<td>{PAGEEDIT_FORM_BRAND_PICTURE_URL_TITLE}</td>
						<td>{PAGEEDIT_FORM_BRAND_PICTURE_URL}</td>
					</tr>

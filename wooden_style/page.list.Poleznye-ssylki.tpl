...
<!-- ENDIF -->
                     	...
                     	<!-- BEGIN: LIST_ROW -->
                     <div class="post">
                         <div class="entry-utility" style="width:130px;">
                        
	<!-- IF {LIST_ROW_MEDP_PAVATAR} -->
                         <img width=100px src="/{LIST_ROW_MEDP_PAVATAR}" alt="" class="frame" />
<!-- ELSE -->
 <img width=100px src="/images/no-image-list-top.png" alt="" class="frame" />
<!-- ENDIF -->
                         </div>
                         <div class="entry-content">
                         	<h2 class="posttitle"><a href="{LIST_ROW_URL}">{LIST_ROW_SHORTTITLE}</a></h2>
                            <p>{LIST_ROW_DESC}</p>
<a class="btn" href="{LIST_ROW_MATER_DOWNLOAD_LINK}">Перейти по ссылке</a>
                         </div>
                         <div class="clear"></div><!-- clear float -->
                     </div><!-- .post -->
	<!-- END: LIST_ROW -->

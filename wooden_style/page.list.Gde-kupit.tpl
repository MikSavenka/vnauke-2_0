...
<div style="background:#fff; width:200px; text-align:right; opacity:0.5; padding:10px; margin-left:790px; margin-top:10px; font-size:28px; color:#1196cf; position:absolute;"><p style="opacity:1.0 !important;">Где <br/>купить?</p></div>

<img src="/images/gde-kupit-top-image.jpg" alt="Где купить" / >	
</div>

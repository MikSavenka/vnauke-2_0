...
<div style="width:462px; float:left; margin-bottom:30px;">
<div style="width:462px; float:left;">
<a href="{PAGE_ROW_URL}"><img src="/{PAGE_ROW_MEDP_PAVATAR}" width="462px" class="frame" style="float:left; margin-right:7px; margin-bottom:15px;"> </a>
...
<div style="width:462px; float:right;">
...
<!-- ELSE -->
<div style="width:462px; margin-right: 100px; float:left; margin-bottom:30px;">
<div style="width:462px; float:left;">
<a href="{PAGE_ROW_URL}"><img src="/{PAGE_ROW_MEDP_PAVATAR}" width="462px" class="frame" style="float:left; margin-right:7px; margin-bottom:15px;"> </a>
<br />
<p><img src="images/icons/comment.png" alt="" />

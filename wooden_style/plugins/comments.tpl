...
<!-- BEGIN: COMMENTS_ROW -->
				<div class="comments1">
					<p style="width:150px; float:left;">{COMMENTS_ROW_AUTHOR_AVATAR}</p>
					<p style="display:inline; float:left;"><a href="{COMMENTS_ROW_URL}" id="c{COMMENTS_ROW_ID}">Комментарий №{COMMENTS_ROW_ORDER}.</a> Автор:{COMMENTS_ROW_AUTHOR}</p>
					<p style="display:inline; margin-left:5px;">[{COMMENTS_ROW_DATE}]</p>
				</div>
				<div class="comments2">

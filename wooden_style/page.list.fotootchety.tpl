...
<!-- ELSE -->
<div style="width:289px; float:left; margin-right:10px !important;">
<!-- ENDIF -->					
<div class="ts-display-pf-img">	
<!-- IF {LIST_ROW_FOTOGAL_THMB} -->
<a style="padding-bottom:0px !important; padding-right:5px !important; display:block; float:left" class="image" 

 href="{LIST_ROW_FOTOGAL_BIG}" title="{LIST_ROW_DESC}" data-rel="prettyPhoto[mixed]" >
<span class="rollover"></span>

<img width=280 src="{LIST_ROW_FOTOGAL_THMB}" />
